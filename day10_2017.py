...
hashlist = list(range(256))
instring = "106,16,254,226,55,2,1,166,177,247,93,0,255,228,60,36"

lengths = [int(el) for el in instring.split(',')]
...
# 	hashlist = rev_in_place(hashlist, currpos, length)
# 	currpos = (currpos + length + skipsize) % len(hashlist)
# 	skipsize += 1
...
hashlist = knot_hash_round(hashlist, lengths)
print("Part 1 solution :", hashlist[0] * hashlist[1])
...
print("Part 2 solution :", ''.join(output_hex))
