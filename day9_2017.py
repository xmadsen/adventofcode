...
with open('day9_input.txt', 'r') as inputtext:
    for line in inputtext:
        instring = line

stream = re.sub('!.', '', instring)
...
stream2 = re.sub('!.', '', instring)
stream2 = [el[1:-1] for el in re.findall('<[^>]+>', stream2)]

print("Part 2 solution :", sum([len(el) for el in stream2]))
